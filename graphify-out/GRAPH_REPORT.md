# Graph Report - C:\Firerfox Portable\Freeflow brain\backend  (2026-04-09)

## Corpus Check
- 123 files · ~91,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 736 nodes · 1122 edges · 121 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `resolveOrderCandidate()` - 15 edges
2. `runNamedGuard()` - 15 edges
3. `normalizeText()` - 12 edges
4. `handleParsedOrderFlow()` - 11 edges
5. `tryWholePhraseSingleItem()` - 10 edges
6. `initEntityCache()` - 9 edges
7. `ensureSessionId()` - 9 edges
8. `setSession()` - 9 edges
9. `getSession()` - 9 edges
10. `liveMetricsRegisterClientStats()` - 9 edges
...
Cohesion: 0.19
Nodes (20): buildItemAliases(), buildItemSearchCorpus(), escapeRegex(), extractItemQueryCandidate(), fetchCityMenuRows(), FindRestaurantHandler, formatDiscoveryReply(), hasPizzaRestaurantSignal() (+12 more)
...
Cohesion: 0.19
Nodes (17): attachLiveGateway(), cartMutationGuard(), confidenceFloorGuard(), confirmGuard(), continuityGuard(), escapeOverrideGuard(), expectedContextGuard(), floatingOrderCleanupGuard() (+9 more)

### Community 9 - "Community 9"
Cohesion: 0.36
Nodes (16): dayKey(), ensureBucket(), estimateCostFromBytes(), getLiveMetricsSnapshot(), getOrCreateSession(), incrementReconnect(), liveMetricsRegisterClientStats(), liveMetricsRegisterReconnect() (+8 more)
...
Cohesion: 0.22
Nodes (6): BrainPipeline, buildMenuSummaryForTTSV2(), buildRestaurantSummaryForTTSV2(), isExplicitRestaurantNavigation(), mapOrderModeEvent(), resolveRecoContextPolicy()
...
Cohesion: 0.39
Nodes (5): buildClarifyResponse(), getOrderModeEvent(), mapToolPayload(), toEntitiesResolved(), ToolRouter
...
Cohesion: 0.6
Nodes (5): dishInMenu(), normalize(), restaurantIdInList(), restaurantNameFuzzyMatch(), verifyToolCall()
...
Cohesion: 0.6
Nodes (3): buildNaturalMenuReplySummary(), MenuHandler, normalizeMenuToken()
...
Cohesion: 0.8
Nodes (4): buildLiveArgsSummary(), compactString(), logLiveEvent(), sanitizeValue()
...
Cohesion: 0.83
Nodes (3): coerceQuantity(), coerceString(), validateAndSanitize()
...
Cohesion: 1.0
Nodes (2): handler(), isLiveModeEnabled()
...
## Knowledge Gaps
- **Thin community `Community 87`** (2 nodes): `amber.js`, `handler()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `brainV2.js`, `handler()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `stats.js`, `handler()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (2 nodes): `supabaseClient.js`, `testSupabaseConnection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (2 nodes): `llmClient.js`, `callLLM()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `llmReasoner.js`, `llmReasoner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (2 nodes): `llmResponse.js`, `llmGenerateReply()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (2 nodes): `smartIntent.js`, `smartResolveIntent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (2 nodes): `shadowLogger.js`, `logShadowComparison()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (2 nodes): `restaurantCatalog.js`, `findRestaurantInText()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (2 nodes): `confirmOrderHandler.js`, `handleConfirmOrder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (2 nodes): `findNearbyHandler.js`, `handleFindNearby()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (2 nodes): `menuRequestHandler.js`, `handleMenuRequest()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (2 nodes): `boostIntent.js`, `boostIntent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (2 nodes): `fallbackIntent.js`, `fallbackIntent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `intentRouterGlue.js`, `resolveIntent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `orderValidator.js`, `validateOrderItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `geoUtils.js`, `calculateDistance()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `restaurantSearch.js`, `findRestaurant()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `DisambiguationService.js`, `resolveMenuItemConflict()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `googleAuth.js`, `getVertexAccessToken()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (2 nodes): `intentLogger.js`, `logIssue()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (2 nodes): `normalizeText.js`, `normalize()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (2 nodes): `testClient.js`, `testClient()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (2 nodes): `textMatch.js`, `scoreRestaurantMatch()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (2 nodes): `GuardChain.js`, `runGuardChain()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (2 nodes): `liveObservability.js`, `emit()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `taxonomy.runtime.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `cartUtils.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `orderEngine.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `recoTelemetry.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `EventLogger.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `logging.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `IntentGroups.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
